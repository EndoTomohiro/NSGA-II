...
def vis_CO2(ind, path):
    ...
    for i, route in enumerate(route_list):
        for j in range(len(route)-1):
            idx = max(0, int(min(19, CO2_list[cnt]) / 3) - 2)
    ...
    for gen in range(1, NGEN):
        ...
        for ind1, ind2 in zip(offspring[::2], offspring[1::2]):
            ...
            if random.random() <= MUPB:
                ...
                # CO2の総排出量が条件を満たしたら出力
                if eval1_1[1] - eval1_2[1] > 20 and eval1_2[1] < 360:
                    print(eval1_1)
                    print(eval1_2)
                    vis_route(ind1_p, "figure/mutation_route_1.png")
                    vis_route(ind1, "figure/mutation_route_2.png")
                    vis_CO2(ind1_p, "figure/mutation_CO2_1.png")
                    vis_CO2(ind1, "figure/mutation_CO2_2.png")
                    exit(0)
            if random.random() <= MUPB:
                ...
                # CO2の総排出量が条件を満たしたら出力
                if eval2_1[1] - eval2_2[1] > 15 and eval2_2[1] < 360:
                    print(eval2_1)
                    print(eval2_2)
                    vis_route(ind1_p, "figure/mutation_route_1.png")
                    vis_route(ind1, "figure/mutation_route_2.png")
