...
def main():
    ...
    for gen in range(1, NGEN):
        ...
        if gen == 200-1:
            ...
            plt.xlabel("総移動距離", fontname="Hiragino Sans")
            plt.ylabel("CO2の総排出量", fontname="Hiragino Sans")
            fig.savefig("figure/selection_1.png")
        ...
        if gen == 200-1:
            ...
            plt.xlabel("総移動距離", fontname="Hiragino Sans")
            plt.ylabel("CO2の総排出量", fontname="Hiragino Sans")
            fig.savefig("figure/selection_2.png")
            print(len(pop))
        ...
        if gen == 200-1:
            ...
            plt.xlabel("総移動距離", fontname="Hiragino Sans")
            plt.ylabel("CO2の総排出量", fontname="Hiragino Sans")
            fig.savefig("figure/selection_3.png")
            exit(0)
